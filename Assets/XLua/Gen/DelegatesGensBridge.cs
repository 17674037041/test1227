...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public testFunc6 __Gen_Delegate_Imp0(int p0, int p1, out int p2, out string p3)
		{
            ...
            lock (luaEnv.luaEnvLock)
            {
                ...
                testFunc6 __gen_ret = (testFunc6)translator.GetObject(L, errFunc + 1, typeof(testFunc6));
		...
		public XLua.LuaFunction __Gen_Delegate_Imp2()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(delefunc6))
			{
			    return new delefunc6(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(delefunc8))
			{
			    return new delefunc8(__Gen_Delegate_Imp1);
			}
		    ...
		    if (type == typeof(delefunc10))
			{
			    return new delefunc10(__Gen_Delegate_Imp2);
			}
